        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 ">
               <h2 class="useful_text">Address</h2>
                 <ul class="location">
                        <li><img src="{{ asset('assets') }}/home/images/map-icon.png">Locations</li>
                        
                        <li><img src="{{ asset('assets') }}/home/images/call-icon.png"><a href="company.html">+71 89078493</a></li>
                        <li><img src="{{ asset('assets') }}/home/images/email-icon.png"><a href="furnitures.html">demo@gmail.com</a></li>
