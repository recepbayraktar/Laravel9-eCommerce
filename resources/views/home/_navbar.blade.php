            ...
            <div class="header-navigation-content">
              <div class="row">
                ...
                <div class="col-md-12 nav-brands">
                  <ul>
                    <li><a href="shop-product-list.html"><img title="esprit" alt="esprit" src="{{ asset('assets') }}/home/pages/img/brands/esprit.jpg"></a></li>
                    <li><a href="shop-product-list.html"><img title="gap" alt="gap" src="{{ asset('assets') }}/home/pages/img/brands/gap.jpg"></a></li>
                    <li><a href="shop-product-list.html"><img title="next" alt="next" src="{{ asset('assets') }}/home/pages/img/brands/next.jpg"></a></li>
                    <li><a href="shop-product-list.html"><img title="puma" alt="puma" src="{{ asset('assets') }}/home/pages/img/brands/puma.jpg"></a></li>
                    <li><a href="shop-product-list.html"><img title="zara" alt="zara" src="{{ asset('assets') }}/home/pages/img/brands/zara.jpg"></a></li>
                  </ul>
                </div>
              </div>
            </div>
