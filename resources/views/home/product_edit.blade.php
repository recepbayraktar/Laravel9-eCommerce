        ...
        <div class="container">
            <div class="row margin-bottom-40 ">
                ...
                <div class="col-sm-8 col-md-4">
                    <form action="{{ route('userProductUpdate', ['id' => $data->id]) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="category_id" id="exampleFormControlSelect1">
                        ...
                        <option value="{{ $rs->id }}" @if ($rs->id == $data->id) selected="selected" @endif>  {{ App\Http\Controllers\Admin\CategoryController::getParentsTree($rs, $rs->title) }}</option>
                        @endforeach
                      </select>
                    </div>
